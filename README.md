...
loaded into internal SRAM. The reel itself is not designed yet; this is the first item.
...
The plate textures in `textures/` are generated by `tools/make_textures.py` (numpy +
