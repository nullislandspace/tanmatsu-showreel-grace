...
| 8 | `warp_out` | done | The hero ship warps away; the marauders fly on for a few seconds, then warp too | 8 |
| 9 | `asteroid_ambush` | done | Another system: the hero comes out of warp and hides behind an asteroid; the marauders arrive and pass it; the hero comes out behind them, gives chase and fires blue lasers | 16 |
| 10 | `marauder_downfall` | done | Close-up of the marauders under blue fire; the yellow one explodes; a couple of seconds later the green one warps away | 9 |
| 11 | `hero_rolls` | done | Close-up of the hero ship flying fast, a couple of barrel rolls, then straight on | 8 |
...
- **D-38** 2026-09-19, Claude (while building scenes 8–11; for the user's review):
  ...
  - **Scene 8 fires no lasers**; the warp is the point of the scene.
