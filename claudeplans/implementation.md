...
| 11.4 | MJPEG export of the full reel; the user checks the video | in progress | 2026-09-19: `make export` at `2ba0993`: 3354 frames (111.8 s) in 866 s, no errors (F-29); the live reel re-installed afterwards (`make install`). The user has since reviewed the reel (10.10), so that video predates D-39; a new export is due |
