...
void station_init(void) {
    ...
    s_mats[STATION_MAT_HULL]  = (mesh_mat_t){texcache_get("space/station_hull.png"), 0xFFC8CACCu, 0};
    s_mats[STATION_MAT_RING]  = (mesh_mat_t){texcache_get("space/station_ring.png"), 0xFFC6C8CAu, 0};
    s_mats[STATION_MAT_SPOKE] = (mesh_mat_t){texcache_get("space/plate_gunmetal.png"), 0xFF5C626Eu, 0};
