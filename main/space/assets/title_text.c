...
static struct {
    ...
    [TITLE_HERO]     = {"space/plate_brushed.png", "space/plate_riveted.png", 0xFFB0B3B8u, 0xFF94979Cu},
    [TITLE_MARAUDER] = {"space/marauder_green.png", "space/plate_gunmetal.png", 0xFF465E38u, 0xFF5C626Eu},
};
