#pragma once
// =====================================================================
//  Showreel  --  the space act: every scene it has
// ---------------------------------------------------------------------
//  One file per scene in space/scenes/, its assets in space/assets/,
//  its textures in textures/space/. Adding a scene: define its
