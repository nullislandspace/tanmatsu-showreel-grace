...
# Hull plate textures (textures/, generated by tools/make_textures.py).
# Installed next to app.so; the app finds them through
# graceloader_get_install_basepath().
TEXTURES := $(notdir $(wildcard textures/*.png))
...
# Regenerate textures/*.png from tools/make_textures.py (needs numpy +
